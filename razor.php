...
mysqli_query($con,"insert into payment(userId,productId,quantity,productPrice) values('".$_SESSION['id']."','$qty','$val34','$totalprice')");
...
$_SESSION['sid']=$pd;
						 ?></a></h4>
				          ...
				          <td class="cart-product-quantity"><span>
<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></span>
...
$_SESSION['pid']=$pdtid;
 ...
 <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="cart-total">Total <span>Rs.<?php echo $totalprice; ?></span></li>
                                </ul>
                                <a href="#" class="proceed-btn"> <form action="thankyou.php" method="POST">
    <!-- Note that the amount is in paise = 50 INR -->
    <script

        src="https://checkout.razorpay.com/v1/checkout.js"
        data-key="rzp_test_udsIbNtTr1TdR5"
        data-amount="<?php echo $totalprice*100; ?>"
        data-buttontext="Pay with Razorpay"
        data-name="Online Shopping"
        data-description="Online Shopping Txn with RazorPay"
        data-image="img/four.jpeg"
        data-prefill.name=""
        data-prefill.email=""
