...
<div class="controls">
<input type="text" id="subcategory" onBlur="userAvailability()" placeholder="Enter SubCategory Name"  name="subcategory" class="span8 tip" required>
...
?>									
										<tr>
											...
											<td>
											<a href="edit-subcategory.php?id=<?php echo $row['id']?>" ><i class="icon-edit" style="color:#800080;"></i></a>
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign" style="color:#800080;"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
