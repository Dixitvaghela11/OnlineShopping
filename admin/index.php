...
$_SESSION['mobileno']=$num['mobileno'];
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg" style="color:#800080;">Admin Login</p>
   <span style="color:red;" ><?php echo htmlentities($_SESSION['errmsg']); ?><?php echo htmlentities($_SESSION['errmsg']="");?></span>
      <form class="user" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Email" name="email" id="exampleInputEmail" required>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password" name="password" id="exampleInputPassword" required="">
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <div class="social-auth-links text-center mb-3">
        <button type="submit" class="btn btn-primary btn-block"style="background-color:#800080;" name="submit">Sign In</button>
      </div>
      <!-- /.social-auth-links -->
   </form>
   <center>
      <p class="mb-1" >
        <a href="forgot-password.php" style="color:#800080;">forgot password?</a>
      </p>
</center>
<center>
      <p class="mb-0">
        <a href="signup.php" class="text-center" style="color:#800080;">New Admin Register</a>
      </p></center>
    </div>
    <!-- /.login-card-body -->
  </div>
