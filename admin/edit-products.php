...
<body>	
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head" style="background-color:#800080;" >
...
<div class="controls">
<input type="number"    name="productShippingcharge"  placeholder="Enter Product Shipping Charge" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>" style="background-color:#800080;" class="btn btn-primary">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>" style="background-color:#800080;" class="btn btn-primary">Change Image</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>" style="background-color:#800080;" class="btn btn-primary">Change Image</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit"style="background-color:#800080;" class="btn btn-primary">Update</button>
											</div>
										</div>
									</form>
							</div>
