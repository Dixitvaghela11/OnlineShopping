...
?>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							<h3 class="name"><a style="color:black;" href="product-details.php?pid=<?php echo htmlentities($rws['id']);?>"><?php echo htmlentities($rws['productName']);?></a></h3>
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary" style="background-color:#B30018;">Add to cart</a>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price" style="color:green;">Rs. <?php echo htmlentities($row['productPrice']);?></span>
											<span style="color:black;" class="price-strike">Rs.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10" >
											<a class="btn btn-primary" style="background-color:#B30018;"
 data-toggle="tooltip" data-placement="right" title="Wishlist" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary" style="background-color:#B30018;"><i class="fa fa-shopping-cart inner-right-vs"></i> ADD TO CART</a>
									</div>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active" ><a data-toggle="tab" style="background-color:#B30018;"  href="#description">DESCRIPTION</a></li>
								<li><a data-toggle="tab"style="color:#B30018;" href="#review">REVIEW</a></li>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			<h3 class="name"><a style="color:black;" href="product-details.php?pid=<?php echo htmlentities($rw['id']);?>"><?php echo htmlentities($rw['productName']);?></a></h3>
			<div class="rating rateit-small"></div>
			...
			<div class="product-price">	
				<span class="price" style="color:green;">
					Rs.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span style="color:black;" class="price-before-discount">Rs.
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary" style="background-color:#B30018;">Add to cart</a>
