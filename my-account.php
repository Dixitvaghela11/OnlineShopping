	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title" >
	        <a data-toggle="collapse"  data-parent="#accordion" href="#collapseOne">
	          <span style="background-color:#B30018;">1</span>My Profile
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <button type="submit" name="update" style="background-color:#B30018;" class="btn btn-primary">Update</button>
					</form>
					<?php } ?>
				</div>	
						    ...
						    <div class="panel-heading">
						      <h4 class="unicase-checkout-title">
						        <a data-toggle="collapse" class="collapsed" data-parent="#accordion" href="#collapseTwo">
						          <span style="background-color:#B30018;">2</span>Change Password
						        </a>
						      </h4>
						    </div>
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <button type="submit" name="submit" style="background-color:#B30018;" class="btn btn-primary">Change </button>
					</form> 
