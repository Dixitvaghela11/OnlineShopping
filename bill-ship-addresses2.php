	...
	<!-- panel-heading -->
    	...
    	<h4 class="unicase-checkout-title" >
	        <a data-toggle="collapse" class="" data-parent="#accordion" href="#collapseOne">
	          <span style="background-color:#B30018;">1</span>Billing Address
	        </a>
	     </h4>
    </div>
    <!-- panel-heading -->
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" style="background-color:#B30018;" class="btn-upper btn btn-primary checkout-page-button">Update</button>
					</form>
					<?php } ?>
				</div>	
