...
<div class="col-md-10 col-sm-10 create-new-account">
...
<div class="form-group">
	  	...
	  	<button type="submit" name="submit" style="background-color:#B30018;" class="btn btn-primary" class="btn-upper btn btn-primary checkout-page-button" id="submit">Sign Up</button>
	</form>
