        ...
        <div class="product-info text-left">
            ...
            <div class="product-price"> 
                <span class="price">
                    ...
                    <div class="action"><div class="add-cart-button btn-group">
                                    <button class="btn btn-info" data-toggle="dropdown" type="button">
            ...
            <div class="product-price"> 
                <span class="price">
                    ...
                    <div class="action"><div class="add-cart-button btn-group">
                        ...
                        <a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="btn btn-warning">Add to cart</a>
