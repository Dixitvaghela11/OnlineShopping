...
header('location:order-history.php');
	...
	elseif($_POST['paymethod']=='razorpay') {
...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="cod" > COD
	     <input type="radio" name="paymethod" value="razorpay"> razorpay
	      <br /><br />
	     <input type="submit" style="background-color:#B30018;" value="submit" name="submit" class="btn btn-primary">
